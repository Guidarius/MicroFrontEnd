(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("lodash/isPlainObject"), require("lodash/padStart"), require("rxjs/Subject"), require("rxjs/BehaviorSubject"), require("rxjs/operator/map"), require("rxjs/operator/switchMap"), require("rxjs/operator/scan"), require("rxjs/Observable"), require("lodash/merge"), require("rxjs/observable/merge"));
	else if(typeof define === 'function' && define.amd)
		define(["lodash/isPlainObject", "lodash/padStart", "rxjs/Subject", "rxjs/BehaviorSubject", "rxjs/operator/map", "rxjs/operator/switchMap", "rxjs/operator/scan", "rxjs/Observable", "lodash/merge", "rxjs/observable/merge"], factory);
	else if(typeof exports === 'object')
		exports["FrintStore"] = factory(require("lodash/isPlainObject"), require("lodash/padStart"), require("rxjs/Subject"), require("rxjs/BehaviorSubject"), require("rxjs/operator/map"), require("rxjs/operator/switchMap"), require("rxjs/operator/scan"), require("rxjs/Observable"), require("lodash/merge"), require("rxjs/observable/merge"));
	else
		root["FrintStore"] = factory(root["_"]["isPlainObject"], root["_"]["padStart"], root["Rx"], root["Rx"], root["Rx"]["Observable"]["prototype"], root["Rx"]["Observable"]["prototype"], root["Rx"]["Observable"]["prototype"], root["Rx"], root["_"]["merge"], root["Rx"]["Observable"]);
...
var _padStart = __webpack_require__(4);
...
var _scan = __webpack_require__(9);

var _ActionsObservable = __webpack_require__(10);
...
var _combineEpics = __webpack_require__(15);
...
exports.default = {
  ...
  combineEpics: _combineEpics2.default
};
module.exports = exports['default'];
...
var _Observable2 = __webpack_require__(11);
...
var ActionsObservable = function (_Observable) {
  ...
  function ActionsObservable(source) {
...
function createStore() {
  ...
  var Store = function (_BaseStore) {
    ...
    function Store() {
      ...
      return _possibleConstructorReturn(this, (Store.__proto__ || Object.getPrototypeOf(Store)).call(this, (0, _merge2.default)(options, opts)));
    }
...
function combineEpics() {
  ...
  return function rootEpic() {
    ...
    var toMerge = epics.map(function (epic) {
      return epic.apply(undefined, args);
    });

    return _merge.merge.apply(undefined, _toConsumableArray(toMerge));
  };
}
module.exports = exports['default'];
