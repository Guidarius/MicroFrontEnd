...
describe('frint › createCore', function () {
  it('is a function', function () {
    (0, _chai.expect)(_createCore2.default).to.be.a('function');
  });

  it('returns App class', function () {
    var MyApp = (0, _createCore2.default)({
    ...
    (0, _chai.expect)(app.getOption('isFrintCore')).to.equal(true);
  });
